public class CostDW implements CostInterface {
    ...
    /**
     * Overriding compareTo to compare the cost and return a positive integer if current cost value is greater than the>     * return a negative if the cost compared to is greater, and zero if equal.
     */
    @Override

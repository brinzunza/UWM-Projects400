...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    /**
     * Resolves any red-black tree property violations that are introduced by inserting each new node into a red-black tree
     * @param newNode a newly added red node (a red node when called recursively)
     */
    protected void enforceRBTreePropertiesAfterInsert(Node<T> newNode) {
        ...
        // Case 2.1: parent is black (do nothing)
        if (parent.blackHeight == 1) {
            return;
        }

        // Case 2.2: parent is red
        ...
        // parent is left child and aunt is black
        else if (!parent.isRightChild()) {
            // *combination rotation is required
    ...
    /**
     * Helper method that returns the aunt node of a child
     * @param parent node to find the aunt of
     * @return the aunt node of the child
     */
...
//
//    /**
//     * Creates a new RedBlackTree of Integers before each test
//     */
//    @BeforeEach
//    public void setup() {
...
//
//    /**
//     * Creates an RBT and manually changes the color of the node 20 to black to check
//     * if the enforceRBTreePropertiesAfterInsert method fixes the violation
//     */
//    @Test
//    void testBlackAunt() {
//        tree.insert(40);
//        tree.insert(20);
//        tree.insert(70);
//        tree.findNodeWithData(70).blackHeight = 1;
//        tree.insert(10);
//        assertEquals(0, tree.findNodeWithData(40).blackHeight);
//        assertEquals(1, tree.findNodeWithData(20).blackHeight);
//        assertEquals(0, tree.findNodeWithData(10).blackHeight);
//        assertEquals(1, tree.findNodeWithData(70).blackHeight);
//    }
//
//    /**
//     * Creates an RBT and checks the tree after inserting node 25 with a black aunt
//     */
//    @Test
//    void testBlackAunt2() {
//        tree.insert(6);
...
//        tree.insert(25);
//
//        assertEquals(1, tree.findNodeWithData(6).blackHeight);
//        assertEquals(1, tree.findNodeWithData(12).blackHeight);
//        assertEquals(1, tree.findNodeWithData(18).blackHeight);
//        assertEquals(0, tree.findNodeWithData(21).blackHeight);
//        assertEquals(0, tree.findNodeWithData(3).blackHeight);
//        assertEquals(0, tree.findNodeWithData(10).blackHeight);
//        assertEquals(0, tree.findNodeWithData(20).blackHeight);
//        assertEquals(0, tree.findNodeWithData(30).blackHeight);
//        assertEquals(1, tree.findNodeWithData(25).blackHeight);
//    }
//
//    /**
//     * Tests that the node 23 is recolored after being inserted
//     */
//    @Test
//    void testRedAunt() {
//        tree.insert(10);
...
//        assertEquals(1, tree.findNodeWithData(15).blackHeight);
//        assertEquals(1, tree.findNodeWithData(20).blackHeight);
//        assertEquals(0, tree.findNodeWithData(25).blackHeight);
//    }
//
//    /**
//     * Tests that the enforceRBTreePropertiesAfterInsert method calls itself recursively
//     * when violating another RBT property after recoloring
//     */
//    @Test
//    void testRecursion() {
//        tree.insert(5);
...
//        tree.insert(30);
//
//        assertEquals(1, tree.findNodeWithData(5).blackHeight);
//        assertEquals(0, tree.findNodeWithData(15).blackHeight);
//        assertEquals(1, tree.findNodeWithData(18).blackHeight);
//        assertEquals(1, tree.findNodeWithData(22).blackHeight);
//        assertEquals(0, tree.findNodeWithData(2).blackHeight);
//        assertEquals(0, tree.findNodeWithData(10).blackHeight);
//        assertEquals(1, tree.findNodeWithData(20).blackHeight);
//        assertEquals(1, tree.findNodeWithData(35).blackHeight);
//        assertEquals(0, tree.findNodeWithData(25).blackHeight);
//        assertEquals(0, tree.findNodeWithData(30).blackHeight);
//    }
//

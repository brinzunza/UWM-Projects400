...
public class CHSearchBackendBD implements CHSearchBackendInterface {
	private HashtableWithDuplicateKeysInterfaceAE<String, PostInterface> hashtable;
	 ...
	 */
	public CHSearchBackendBD(HashtableWithDuplicateKeysInterfaceAE<String, PostInterface> hashtable,

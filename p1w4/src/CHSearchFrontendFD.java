...
public class CHSearchFrontendFD implements CHSearchFrontendInterface{
        ...
        private CHSearchBackendInterface back;

        public CHSearchFrontendFD(Scanner input, CHSearchBackendInterface back) {
            this.input = input;
            this.back = back;
        }
    ...
    @Override
        public void searchTitleCommand(List<String> words) {
            ...
            System.out.println(back.findPostsByTitleWords(result));
        }
    ...
    @Override
        public void searchBodyCommand(List<String> words) {
            ...
            System.out.println(back.findPostsByBodyWords(result));
        }
    ...
    @Override
        public void searchPostCommand(List<String> words) {
            ...
            System.out.println(back.findPostsByTitleOrBodyWords(result));
        }
    ...
    @Override
        public void displayStatsCommand() {
            System.out.println(back.getStatisticsString());
        }
